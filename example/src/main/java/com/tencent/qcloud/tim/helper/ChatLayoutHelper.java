...
//        });
        ...
        ////// 设置聊天背景 //////
        messageLayout.setBackgroundColor(context.getResources().getColor(R.color.main_bg_color));
        ////// 设置头像 //////
        ...
        messageLayout.setNameFontColor(R.color.color_black);

        ////// 设置气泡 ///////
        // 设置自己聊天气泡的背景
//        messageLayout.setRightBubble(context.getResources().getDrawable(R.drawable.chat_self_bg));
//        // 设置朋友聊天气泡的背景
//        messageLayout.setLeftBubble(context.getResources().getDrawable(R.drawable.chat_opposite_bg));

        ////// 设置聊天内容 //////
        // 设置聊天内容字体字体大小，朋友和自己用一种字体大小
        messageLayout.setChatContextFontSize(14);
        // 设置自己聊天内容字体颜色
        messageLayout.setRightChatContentFontColor(R.color.color_black_3);
        // 设置朋友聊天内容字体颜色
        messageLayout.setLeftChatContentFontColor(R.color.color_black_3);

        ////// 设置聊天时间 //////
        // 设置聊天时间线的背景
        messageLayout.setChatTimeBubble(new ColorDrawable(context.getResources().getColor(R.color.main_bg_color)));
        // 设置聊天时间的字体大小
        messageLayout.setChatTimeFontSize(12);
        // 设置聊天时间的字体颜色
        messageLayout.setChatTimeFontColor(R.color.color_gray_99);
        ...
        public void onDraw(ICustomMessageViewGroup parent, MessageInfo info) {
            ...
            switch(customMessageData.type) {
                case CustomMessageData.TYPE_HYPERLINK:
                    view = LayoutInflater.from(GLApplication.getInstance()).inflate(R.layout.test_custom_message_layout1, null, false);
                    // 把自定义消息view添加到TUIKit内部的父容器里
                    parent.addMessageContentView(view);
                    break;
                case CustomMessageData.TYPE_PUSH_TEXT_VIDEO:
                    view = LayoutInflater.from(GLApplication.getInstance()).inflate(R.layout.test_custom_message_layout2, null, false);
                    // 把自定义消息view添加到TUIKit内部的父容器里
