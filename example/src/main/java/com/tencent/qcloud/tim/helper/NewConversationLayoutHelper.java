...
import com.tencent.qcloud.tim.view.OasisConversationLayout;

public class NewConversationLayoutHelper {

    public static void customizeConversation(OasisConversationLayout layout) {
        ...
        listLayout.enableItemRoundIcon(false);// 设置adapter item头像是否显示圆角，默认是方形
