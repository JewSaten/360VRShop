...
public class PLCamera extends PLRenderableElementBase implements PLICamera
{
	...
	private PLCameraListener mRotateListener2;
	...
	public void setOnRotateListener(PLCameraListener listener){
		mRotateListener2 = listener;
	}
	...
	@Override
	public PLCameraListener getOnRotateListener() {
		return null;
	}
	...
	public void rotate(Object sender, CGPoint startPoint, CGPoint endPoint)
	{
		if(mIsNotLocked)
		{
			...
			if(didRotatePitch || didRotateYaw)
			{
				...
				if(mListener != null)
					mListener.didRotate(sender, this, pitch, yaw, roll);
				if(mRotateListener2 != null)
					mRotateListener2.didRotate(sender, this, pitch, yaw, roll);
			}
		}
	}
