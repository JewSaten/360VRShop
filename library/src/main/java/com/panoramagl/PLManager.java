...
public class PLManager implements PLIView, SensorEventListener, OnDoubleTapListener {
                    ...
                    (
                            new PLLoaderListener() {
                                ...
                                public void didBegin(PLILoader loader) {
                                    ...
                                    if (listener != null)
                                        listener.onDidBeginLoader(PLManager.this, loader);
                                }
                                ...
                                public void didComplete(PLILoader loader) {
                                    ...
                                    PLViewListener listener = getListener();
                                    if (listener != null)
                                        listener.onDidCompleteLoader(PLManager.this, loader);
                                }
                                ...
                                public void didStop(PLILoader loader) {
                                    ...
                                    PLViewListener listener = getListener();
                                    if (listener != null)
                                        listener.onDidStopLoader(PLManager.this, loader);
                                }
                                ...
                                public void didError(PLILoader loader, String error) {
                                    ...
                                    PLViewListener listener = getListener();
                                    if (listener != null)
                                        listener.onDidErrorLoader(PLManager.this, loader, error);
                                }
                            }
                    );
            if (showProgressBar) {
                ...
                handler.postDelayed
                        (
                                new Runnable() {
                                    @Override
                                    public void run() {
                                        loader.load(PLManager.this, transition, initialPitch,
                                                initialYaw);
                                    }
                                },
                                300
    ...
    protected class PLInternalCameraListener implements PLCameraListener, PLIReleaseView {
        ...
        private PLManager mView;

        /**
         * init methods
         */

        public PLInternalCameraListener(PLManager view) {
            super();
            mView = view;
        }
